...
namespace BTLtest2.function
{
    class functionnhacungcap
    {
        ...
        public static void Connect()
        {
            ...
            connString = "DESKTOP-EE2I4RJ;Initial Catalog=laptrinh.net;Integrated Security=True;Trust Server Certificate=True";
            //connString = "Data Source=ADMIN\\MSSQLSERVER03;Initial Catalog=BTLtest2;Integrated Security=True;Encrypt=True;TrustServerCertificate=True";
        ...
        {
            SqlDataAdapter Mydata = new SqlDataAdapter(sql, functionnhacungcap.Conn);
        ...
        public static DataTable GetDataToTable(string sql)
        {
            ...
            Mydata.SelectCommand.Connection = functionnhacungcap.Conn; 	// Kết nối CSDL
        ...
        public static void RunSql(string sql)
        {
            ...
            cmd.Connection = functionnhacungcap.Conn;	  // Gán kết nối
        ...
        public static void RunSqlDel(string sql)
        {
            ...
            cmd.Connection = functionnhacungcap.Conn;
            cmd.CommandText = sql;
            try
            {
                cmd.ExecuteNonQuery();
